...
import com.elitbet.parser.impl.FootballCreateParserFlashScore;
...
public class FootballFinishedParserFlashScore implements Parser {
    ...
    FootballFinishedParserFlashScore(){
    ...
    private int[] parseGoals(String eventScoreRaw){
    ...
    public void parse() throws InterruptedException, ParseException {
        ...
        for(Element tournamentTable:tournamentTables){
            ...
            for(Element tournamentEvent:tournamentEvents){
                ...
                int [] goals = parseGoals(eventScoreRaw);
